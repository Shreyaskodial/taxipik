...
{/*     <!-- Vertical Navbar --> */}
 ...
 {/*        <!-- Header --> */}
        ...
        <main class="py-6 bg-surface-secondary">
          ...
          <tr key={bookings._id}>
            <td>{bookings.pickup}</td>
            <td> {bookings.drop}</td>
            <td> {bookings.capacity}</td>
            <td> {bookings.email}</td>
            <td> {bookings.phone}</td>
            <td> {bookings.startdate}</td>
            <td> {bookings.enddate}</td>
            
            <td> <button  className=' btn-outline-primary' onClick={() => handleConfirm(bookings)}>Confirm</button></td>   
            <td className='text-primary'><NavLink  to="/bookingsupdate" ><i class="bi bi-eye"></i> </NavLink></td>   
            <td className='text-danger' onClick={() => handleDelete(bookings._id)}><i class="bi bi-trash"></i></td>
