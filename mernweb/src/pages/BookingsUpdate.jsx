...
const BookingsUpdate = () => {
    ...
    const [updatedData, setUpdatedData] = useState({
      ...
      const handleUpdate = async () => {
        const bookId = '64df0cfd61dee0923dc4c61f'; // Replace with the actual book ID
        try {
          const response = await axios.put(`/book/${bookId}`, updatedData);
          console.log(response.data); // Should print 'updated'
...
<div className="col text-center">
  <h4 className='pt-1 g text-white shadow   rounded'>  <i className="fa fa- fa-1x mb-3">  Enter the below details to Update </i></h4>
</div>
...
<form class="row g-3 pt-3" >
  <div class="col-md-4">
    ...
    name="pickup" value={updatedData.pickup} onChange={handleInputChange} required />
  </div>
  <div class="col-md-4">
    <label for="validationDefault02" class="form-label">Drop Location</label>
    <input type="text" class="form-control" id="validationDefault02" 
    name="drop" value={updatedData.drop} onChange={handleInputChange} required />
  </div>
 ...
 <div className="col-md-4">
  ...
  <div className="input-group">
    ...
    <select
      ...
      name="capacity" value={updatedData.capacity} onChange={handleInputChange}
    >
  ...
  <div class="col-md-3">
    ...
    name="startdate" value={updatedData.startdate} onChange={handleInputChange}  required />
  </div>
  <div class="col-md-3">
    <label for="validationDefault04" class="form-label">End date</label>
    <input type="date" class="form-control" id="validationDefault03" 
    name="enddate" value={updatedData.enddate} onChange={handleInputChange}required />
  </div>
  <div class="col-md-3">
    ...
    <input type="number" class="form-control" id="validationDefault03" 
     name="phone" value={updatedData.phone} onChange={handleInputChange} required />
  </div>
